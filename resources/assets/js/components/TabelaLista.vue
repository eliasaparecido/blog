            ...
            <tr v-for="(item,index) in lista" :key="item.id">
                ...
                <td v-if="detalhe || editar || deletar">
                    ...
                    <span v-if="!token">
                        ...
                        <a v-if="editar && !modal" v-bind:href="editar">Editar |</a>
                        <modallink  v-if="editar && modal" tipo="link" nome="editar" v-bind:item="item" v-bind:url="editar" titulo="Editar |" css=""></modallink>
    ...
    export default {
      ...
      computed:{
          lista:function(){
              ...
              let lista = this.itens.data;//para paginar se nao quiser paginar usar this.itens no lugar de lista
